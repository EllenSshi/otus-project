...
class BasePageLocators:
    ...
    BOARDS_BTN = (By.CSS_SELECTOR, 'data-test-id=header-boards-menu-button')
    ...
    BOARDS_BTN = (By.CSS_SELECTOR, 'a[href*="/boards"]')
...
class BoardPageLocators:
    ...
    ADD_LIST_BTN = (By.CSS_SELECTOR, 'span.placeholder')
...
class TemplatePageLocators:
    USE_TMPL_BTN = (By.CSS_SELECTOR, "button[type=button]")
